...
public class WindowCache {
	...
	public static void reconfigure(WindowCacheConfig cfg) {
		...
		if (oc != null)
		{
			//System.out.println("Time:"+java.time.LocalTime.ofNanoOfDay(java.lang.System.currentTimeMillis() % 86_400_000 * 1_000_000L).format(java.time.format.DateTimeFormatter.ofPattern("HH:mm:ss,SSS"))+"; Method: WindowCache.reconfigure. Table size is: "+oc.tableSize+"; useMMAP is: "+cfg.isPackedGitMMAP());
			oc.removeAll();
		}
	...
	private WindowCache(WindowCacheConfig cfg) {
		...
		//System.out.println("Time:"+java.time.LocalTime.ofNanoOfDay(java.lang.System.currentTimeMillis() % 86_400_000 * 1_000_000L).format(java.time.format.DateTimeFormatter.ofPattern("HH:mm:ss,SSS"))+"; Method: WindowCache.WindowCache(cfg); Initialized. mmap = "+mmap);
		...
		//System.out.println("Time:"+java.time.LocalTime.ofNanoOfDay(java.lang.System.currentTimeMillis() % 86_400_000 * 1_000_000L).format(java.time.format.DateTimeFormatter.ofPattern("HH:mm:ss,SSS"))+"; Method: WindowCache.WindowCache(config). numRemovalBlocks is "+numRemovalBlocks+"; tableSize is "+tableSize);
	...
	private void queueRemoveAll(Set<Pack> packs) {
		...
		//System.out.println("Time:"+java.time.LocalTime.ofNanoOfDay(java.lang.System.currentTimeMillis() % 86_400_000 * 1_000_000L).format(java.time.format.DateTimeFormatter.ofPattern("HH:mm:ss,SSS"))+"; Method: WindowCache.queueRemoveAll(); Packs to remove size: "+packsToRemove.size());
	...
	private boolean removeNextBlock(int numRemoved) {
		...
		//System.out.println("Time:"+java.time.LocalTime.ofNanoOfDay(java.lang.System.currentTimeMillis() % 86_400_000 * 1_000_000L).format(java.time.format.DateTimeFormatter.ofPattern("HH:mm:ss,SSS"))+"; Method: WindowCache.removeNextBlock; Block index to remove: "+block+"; mmap is "+mmap);
