...
public class InstallationBlocksImportExportTest {
    ...
    void extensionIsInstalled() throws Exception {
        var req = HttpRequest.newBuilder()
                .uri(URI.create(stack.thingworx.getExternalUrl() + "/Thingworx/Things/GIT.Utility.Thing"))
        ...
        assertEquals(
                200, res.statusCode(), "GIT.Utility.Thing must be accessible: " + res.statusCode() + " " + res.body());
    }
    ...
    void sourceControlFunctionsResourceExists() throws Exception {
        var req = HttpRequest.newBuilder()
                .uri(URI.create(stack.thingworx.getExternalUrl() + "/Thingworx/Resources/SourceControlFunctions"))
                .header("Accept", "application/json")
                .header("Authorization", authHeader)
                .header("X-XSRF-TOKEN", "TWX-XSRF-TOKEN-VALUE")
                .header("X-Requested-By", "ThingWorx")
                ...
                .build();
        var res = stack.httpClient.send(req, HttpResponse.BodyHandlers.ofString());
        assertEquals(200, res.statusCode(), "SourceControlFunctions resource must be accessible: " + res.statusCode());
    }
    ...
    void entityServicesResourceExists() throws Exception {
        var req = HttpRequest.newBuilder()
                .uri(URI.create(stack.thingworx.getExternalUrl() + "/Thingworx/Resources/EntityServices"))
                .header("Accept", "application/json")
                .header("Authorization", authHeader)
                .header("X-XSRF-TOKEN", "TWX-XSRF-TOKEN-VALUE")
                .header("X-Requested-By", "ThingWorx")
                ...
                .build();
        var res = stack.httpClient.send(req, HttpResponse.BodyHandlers.ofString());
        assertEquals(200, res.statusCode(), "EntityServices resource must be accessible: " + res.statusCode());
    }
    ...
    void createProjectViaEntityServices() throws Exception {
        ...
        var uri = URI.create(
                stack.thingworx.getExternalUrl() + "/Thingworx/Resources/EntityServices/Services/CreateProject");
        var req = HttpRequest.newBuilder()
                .uri(uri)
    ...
    void createThingViaEntityServices() throws Exception {
        ...
        var uri = URI.create(
                stack.thingworx.getExternalUrl() + "/Thingworx/Resources/EntityServices/Services/CreateThing");
        var req = HttpRequest.newBuilder()
                .uri(uri)
                .header("Content-Type", "application/json")
                .header("Accept", "application/json")
        ...
        var repositoryReq = HttpRequest.newBuilder()
                .uri(uri)
                .header("Content-Type", "application/json")
                .header("Accept", "application/json")
                .header("Authorization", authHeader)
                ...
                .timeout(Duration.ofSeconds(30))
                .build();
        var repositoryRes = stack.httpClient.send(repositoryReq, HttpResponse.BodyHandlers.ofString());
        assertTrue(
                repositoryRes.statusCode() == 200 || repositoryRes.statusCode() == 201,
                "Create FileRepository should work: " + repositoryRes.statusCode() + " " + repositoryRes.body());
    }
    ...
    void exportEntityToXmlViaExporter() throws Exception {
        var uri = URI.create(stack.thingworx.getExternalUrl() + "/Thingworx/Exporter/Things/" + TEST_THING);
        var req = HttpRequest.newBuilder()
                .uri(uri)
        ...
        assertEquals(
                ...
                "GET /Thingworx/Exporter/Things/<name> with Accept: text/xml should return entity XML. "
                        ...
                        + " Body: "
                        + res.body());
        assertTrue(res.body().contains("<Thing"), "Response should contain entity XML: " + res.body());
    }
    ...
    void exportAndReimportByFileRoundTrip() throws Exception {
        var exportUri = URI.create(stack.thingworx.getExternalUrl() + "/Thingworx/Exporter/Things/" + TEST_THING);
        ...
        assertEquals(
                200,
                exportRes.statusCode(),
                "GET /Thingworx/Exporter/Things/<name> should return XML: " + exportRes.statusCode());
        assertTrue(exportRes.body().contains("<Thing"), "Response should contain entity XML");

        String xmlWithNewName =
                exportRes.body().replaceFirst("name=\"" + TEST_THING + "\"", "name=\"" + TEST_THING_IMPORTED + "\"");
    ...
    void verifyImportedEntityExists() throws Exception {
        var uri = URI.create(stack.thingworx.getExternalUrl() + "/Thingworx/Things/" + TEST_THING_IMPORTED);
        var req = HttpRequest.newBuilder()
                .uri(uri)
                .header("Accept", "application/json")
                .header("Authorization", authHeader)
