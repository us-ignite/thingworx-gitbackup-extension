...
public class GitUtilityThing extends Thing {
        ...
        Thing dataTable =
                (Thing)
                        EntityUtilities.findEntity(
                                "GitBackup.Log.DataTable", ThingworxRelationshipTypes.Thing);
    ...
    public void AddNewRepo(
        ...
        InfoTable configTable =
                InfoTableInstanceFactory.createInfoTableFromDataShape(
                        "GitBackup.ConfigurationSetting");
    ...
    @ThingworxServiceDefinition(
            name = "DeleteGitThing",
            description =
                    "Deletes a GitBackup Thing involves two operations: 1. Deleting the Thing itself and 2. Deleting the FileRepository subfolder that stored that Git repository.",
            category = "",
            isAllowOverride = false,
            aspects = {"isAsync:false"})
    @ThingworxServiceResult(
    ...
    @ThingworxServiceResult(
            ...
            description = "",
            baseType = "INFOTABLE",
            aspects = {"isEntityDataShape:true", "dataShape:GitBackup.ExtensionVersion"})
    public InfoTable GetGitExtensionVersion() throws Exception {
        InfoTable result =
                InfoTableInstanceFactory.createInfoTableFromDataShape("GitBackup.ExtensionVersion");
        PlatformSubsystem platformSubsystem =
                (PlatformSubsystem)
                        EntityUtilities.findEntity(
                                "PlatformSubsystem", ThingworxRelationshipTypes.Subsystem);
    ...
    @ThingworxServiceDefinition(
            ...
            description =
                    "This service gets the list of the Git Things in the System, plus one additional Mashup for the plus sign",
            category = "",
            isAllowOverride = false,
            aspects = {"isAsync:false"})
    @ThingworxServiceResult(
            ...
            description = "",
            baseType = "INFOTABLE",
            aspects = {"dataShape:GitBackup.GitHeader"})
    public InfoTable GetGitHeaderTabs() throws Exception {
        InfoTable result =
                InfoTableInstanceFactory.createInfoTableFromDataShape("GitBackup.GitHeader");
        ThingTemplate gitTemplate =
                (ThingTemplate)
                        EntityUtilities.findEntity(
                                "GitBackupTemplate", ThingworxRelationshipTypes.ThingTemplate);
        ValueCollection queryParams = new ValueCollection();
        queryParams.put("maxItems", integerPrimitive(0));
        ...
        for (int x = 0; x < gitThings.getRowCount(); x++) {
            ...
            entry.put(
                    "GitThingName",
                    new StringPrimitive(row.getPrimitive("name").getValue().toString()));
            result.addRow(entry);
        }
        return result;
    }
        ...
        try {
            ...
            if (propVal != null && propVal.getValue() != null) {
                entry.put(
                        ...
                        currentUser.getPropertyValue("UseGitCommitUserValues"));
            } else {
    ...
    @ThingworxServiceDefinition(
            ...
            description =
                    "Sets the Git committer name, email, and the UseGitCommitUserValues flag on the current user's extension properties.",
            category = "",
            isAllowOverride = false,
            aspects = {"isAsync:false"})
    @ThingworxServiceResult(
    ...
    public void SetGitUserExtensionsProperties(
            ...
            @ThingworxServiceParameter(
                            ...
                            description = "",
                            baseType = "BOOLEAN")
                    Boolean UseGitCommitUserValues)
            throws Exception {
        User currentUser = UserUtilities.findUser(GetCurrentUser());
        ...
        currentUser.setPropertyValue(
                "UseGitCommitUserValues", new BooleanPrimitive(UseGitCommitUserValues));
    }
    ...
    public InfoTable GetProjectEntities(
        ...
        if (isBlank(project))
            throw new Exception(
                    "Can not retrieve the entities that are part of the Project. The project name was not specified or it's empty");
    ...
    public void ImportEntity(
        ...
        if (importTargets == null)
            throw new Exception(
                    "ExtensionImportTargets not configured. Run InitExtensionImportTargets first.");
    ...
    public InfoTable ImportProjectEntities(
            @ThingworxServiceParameter(
                            name = "GitThingName",
                            description =
                                    "GitBackup Thing name whose FileRepository and path to scan",
                            baseType = "STRING")
                    String GitThingName,
            @ThingworxServiceParameter(
                            name = "entityPath",
        ...
        if (isBlank(GitThingName)) throw new Exception("GitThingName is required.");
        ...
        InfoTable result =
                InfoTableInstanceFactory.createInfoTableFromDataShape("GitBackup.TestResult");
    ...
    public void InitUserExtensionGpgKeysProperty() throws Exception {
        ...
        if (!hasGpgKeys) {
            ...
            addPropParams.put("defaultValue", new StringPrimitive(""));
            addPropParams.put(
                    "description", new StringPrimitive("User-specific GPG signing keys store."));
            addPropParams.put("readOnly", new BooleanPrimitive(false));
            addPropParams.put("type", new StringPrimitive("INFOTABLE"));
    ...
    public void SetGpgKey(
        ...
        if (gpgKeys == null) {
            ...
            InfoTable cloned =
                    InfoTableInstanceFactory.createInfoTableFromDataShape("GitBackup.GpgKey");
    ...
    @ThingworxServiceDefinition(
            ...
            description =
                    "Stores or updates Git credentials for a GitBackup thing in the current user's GitCredentials property.",
            category = "",
            isAllowOverride = false,
            aspects = {"isAsync:false"})
    @ThingworxServiceResult(
    ...
    public void SyncProjectToRepository(
            @ThingworxServiceParameter(
                            name = "GitThingName",
                            description = "GitBackup Thing name to sync",
                            baseType = "STRING")
                    String GitThingName)
            throws Exception {
        ...
        if (isBlank(str_ProjectName)) {
            _logger.warn(
                    "SyncProjectToRepository: No project configured for "
                            + GitThingName
                            + ", skipping sync.");
            return;
        }
    ...
    @ThingworxServiceDefinition(
            name = "SetProjectName",
            description =
                    "Updates the ProjectName field on a GitBackup Thing's Configuration table.",
            category = "",
            isAllowOverride = false,
            aspects = {"isAsync:false"})
    @ThingworxServiceResult(
    ...
    private Thing resolveCallingThing() throws Exception {
        ...
        throw new Exception(
                "Could not resolve calling GitThing. Ensure the service is invoked on a GitBackup Thing.");
    }
