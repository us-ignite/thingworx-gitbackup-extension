...
public class InstallationBlocksImportExportTest {
    ...
    public void beforeAll() throws Exception {
        ...
        stack = new JGitExtensionTestStack(credentials, false);
        authHeader =
                "Basic "
                        + Base64.getEncoder()
                                .encodeToString(
    ...
    void exportAndReimportByFileRoundTrip() throws Exception {
        ...
        assertEquals(
                ...
                "GET /Thingworx/Exporter/Things/<name> should return XML: "
                        + exportRes.statusCode());
    ...
    private HttpRequest.BodyPublisher ofMultipartFileBody(String xmlContent, String boundary) {
        ...
        byteArrays.add(
                "Content-Disposition: form-data; name=\"file\"; filename=\"entity.xml\"\r\n"
                        .getBytes(StandardCharsets.UTF_8));
