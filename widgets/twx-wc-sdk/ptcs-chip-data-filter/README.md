...
| dateOrder              | String  | Date order (auto, YMD, MDY, DMY)                                                                             | YMD       |
| daysContainingData     | Array [Date type] | Adds indicator dots that enable you to highlight days that contain data values                     |           | No                        |
