...
class PTCSchipDataFilterChipChild extends PTCS.BehaviorStyleable(L2Pw(LitElement)) {
    ...
    render() {
        return html`<div id="oval-container" part="oval-container">
                    <ptcs-label id="content" part="content" .label=${this.content}></ptcs-label>
                    <div id="cross-button-container" part="cross-button-container">
                        <ptcs-button tabindex="-1" id="cross-button" part="cross-button" @click=${this.closeChip}
                        variant="small" icon=${'cds:icon_close_mini'} .mode=${'icon'}
