...
PTCS.StateUnit = class extends LitElement {
    static get is() {
    ...
    updated(changedProperties) {
        if (changedProperties.has('wc') ||
            changedProperties.has('part') ||
            changedProperties.has('property') ||
            changedProperties.has('enforce') ||
            changedProperties.has('state')) {
            this._subscribe();
        }
        if (changedProperties.has('stateKey')) {
            this._stateKeyChanged(this.stateKey, changedProperties.get('stateKey'));
        }
    }
