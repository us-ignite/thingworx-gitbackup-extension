export class QuickFilter {
    ...
    set data(data) {
        ...
        if (data) {
            ...
            // NOTE: It is a very strange design decision to give the quick filter control over the selection message.
            //       This should be refactored as soon as we need to do any relevant changes in these areas.
            if (data.selectMethod) {
                // Need a nudge, in case data.selectMethod is already assigned when attached to the quick filter
                this.dmSelectMethod(data.selectMethod);
            }
        }
    }
