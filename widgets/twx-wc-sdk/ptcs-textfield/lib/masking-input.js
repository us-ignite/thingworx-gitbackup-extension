...
var inputMask = {
  ...
  createShell : function (t) {
    ...
    t.setAttribute('maxlength', Math.min(placeholder.length, this.wc.maxNumberOfCharacters));
    t.setAttribute('data-placeholder', dataHintText);
    t.setAttribute('data-hint-text-2', pTxt ? pTxt : "");
    t.setAttribute('data-maxlength', Math.min(+maxlength, this.wc.maxNumberOfCharacters));
  ...
  removeShell : function (t) {
    ...
    t.setAttribute('maxlength', Math.min(+maxlength, this.wc.maxNumberOfCharacters));
