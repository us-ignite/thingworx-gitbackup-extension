...
| ------------ | -------- | ------------------------------- |
| text-changed | { text } | Triggered when the text changes. Text is in event.detail.value |
| clear-text   |          | Triggered when user clicks the clear button after text is cleared out |
